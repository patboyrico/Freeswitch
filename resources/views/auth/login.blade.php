...
<html lang="en">
	...
	<head>
		<base href="../../../">
		<meta charset="utf-8" />
		<title>Jamisi PBX | Admin Login </title>
		<meta name="description" content="Jamisi Login Page">
		...
		<!--end::Layout Skins -->
		<link rel="shortcut icon" href="{{ asset('media/j1.png')}}" />
	</head>
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<div class="kt-grid kt-grid--ver kt-grid--root">
			<div class="kt-grid kt-grid--hor kt-grid--root kt-login kt-login--v2 kt-login--signin" id="kt_login">
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="background: linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url({{ asset('media/jamisi-background.jpg')}});
					...
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
							<div class="kt-login__logo">
								<a href="#">
									<img src="{{ asset('media/jamisi_mail.png')}}">
								</a>
							</div>
							<div class="kt-login__signin">
								<div class="kt-login__head">
									<h3 class="kt-login__title">Sign In To Admin Dashboard</h3>
								</div>
                                <form class="kt-form" method="POST" action="{{ route('create.freeswitch') }}">
                                    @csrf
